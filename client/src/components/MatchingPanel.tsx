              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-xs text-muted-foreground">{m.distance} km away</span>
                    <div className="flex flex-wrap gap-1">
                      {m.skills?.map((s: any) => (
                        <span key={s.name} className="px-1.5 py-0.5 rounded bg-secondary text-[9px] uppercase font-bold tracking-tighter">
                          {s.name}
                        </span>
                      ))}
                    </div>
